/**
 * 사전방문 앱 다운로드 안내 페이지 (/visit/:uuid/app-download)
 * UUID를 유지하면서 앱 설치 안내 후 예약 페이지로 이동
 */
...
export default function PrevisitAppDownloadPage() {
      ...
      >
        <Container maxWidth="sm" sx={{ py: 4 }}>
          ...
          <Button
            ...
            onClick={() => navigate(`/visit/${uuid}/reservation`)}
